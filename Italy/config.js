...
//SECOND CHAPTER//
        {
            ...
            alignment: 'right',
            hidden: false,
            title: 'Jews in Italy and the Nazi Occupation',
            image: '',
...
//THIRD CHAPTER//
		...
		//THIRDB ROCKY VIDEO CHAPTER//
        {
			...
			image: '',
            description: '<p><i>A brief recreation of Bartali delivering hidden identification documents for the Assisi Network</i></p><p><iframe width="100%" height="500" src="https://www.youtube.com/embed/1EPPuP-Ew8k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>',
            location: {
                center: [11.26244, 43.76776],
                zoom: 14.88,
                pitch: 0,
	...
	//FOURTH A CHAPTER//
        {
            ...
            alignment: 'full',
            hidden: false,
            title: 'The Assisi Network',
            image: '',
            description: '<p><i>The friary adjacent to the Basilica of Saint Francis looms like a fortress above the walls encircling the holy city of Assisi, Italy.</i></p><p><img src="./images/Assisi.jpg"></p>',
            location: {
	...
	//FOURTH CHAPTER//
			...
			//FOURTH C San Damiano CHAPTER//
        {
            ...
            alignment: 'full',
            hidden: false,
            title: 'San Damiano Monastery',
            image: '',
            description: '<p><i>“The idea of taking part in an organization that could boast a champion like Gino Bartali among its ranks, filled me with such pride that my fear took a back seat.” - Trento Brizi (Road to Valor, 2012)</i></p><p><img src="./images/SanDamiano.jpg"></p>',
            location: {
                center: [12.60977, 43.06866],
                zoom: 15.68,
                pitch: 45,
...
//SIXTH CHAPTER//
        {
            ...
            alignment: 'right',
            hidden: false,
            title: 'Terontola Train Station',
            image: './images/TerontolaBridge.jpg',
            description: '<p><i>The bridge overlooking the Terontola train station where Bartali would wait until the right moment.</i></p><p>One of Bartali’s most daring actions that he performed regularly was to distract Nazi and fascist guards at a small train station in the village of Terontola, not far from Assisi. The station was an important rail line between the Nazi occupied north and Allied freedom to the south and was heavily guarded. Bartali would wait on a small bridge overlooking the station and at the planned time, arrive at the station’s café to great fanfare. The people in the village and the guards themselves would crowd around the champion and he would treat them to tales of his races while enjoying an espresso.</p>',
            location: {
		...
		//SIXTH A CHAPTER//
        {
            ...
            alignment: 'right',
            hidden: false,
            title: 'The Flight South from Terontola',
            image: '',
            description: '<p>His arrival at the small train station was a well-coordinated ruse with the Italian partisans to sneak Jews with fake identification cards onto the train that had just arrived and was headed south to Allied territory. The Nazi guards regularly checked documents of anyone who appeared suspicious, so this distraction gave them a precious five minutes to escape undetected. Bartali would keep the crowd’s attention and then wave goodbye, promising to stop again the following week.</p>',
            location: {
...
bearing: 0.00
		...
		//SEVENTH CHAPTER//
        {
            ...
            alignment: 'full',
            hidden: false,
            title: 'Helping His Jewish Friends',
            image: '',
...
//EIGHTH CHAPTER//
        {
            ...
            alignment: 'right',
            hidden: false,
            title: 'The Return to Racing',
            image: './images/BartaliOnShoulders.jpeg',
            description:'<p><i>Igniting the passion of a war torn nation by winning the Giro d’Italia in 1946</i></p><p>Bartali held tight to his role in WWII, as did many others in the Assisi Network who died with their secrets. Additionally, Italys cities, villages, and infrastructure had been ravaged into ruins, so the country was consumed by the mindset to move forward and rebuild. Bartali was 30 years old when the war ended in 1944 and he focused on proving his racing form despite his lost war years. He resumed racing and reclaimed his grand tour titles in 1946 and 1948 to great fanfare as Italy struggled to rebuild its national identity after the war.</p><p><iframe width="100%" height="500" src="https://www.youtube.com/embed/oc1EZISLhpg?start=8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>',
   location: {
center: [28.15015, 49.45338],
zoom: 3.88,
pitch: 0.00,
